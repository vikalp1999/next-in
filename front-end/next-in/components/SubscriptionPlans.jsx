...
export const SubscriptionPlans = () => {
    ...
    return (
        <Flex w="100vw" bg="#EDF2FE" flexDirection={"column"} alignItems="center">
            <Heading color="#034366" m="30px auto" fontSize="36px" textTransform={"uppercase"} mt="80px">Subscription Plans</Heading>
            <SimpleGrid margin="auto" padding ={"2px"} width={{base:"60%",lg:"85%"}} columns={3} spacing={3} templateColumns={{base:'repeat(1, 1fr)',lg:'repeat(3, 1fr)'}} mb="40px">
                ...
                <Card key={i} bg="white" p="12px" borderRadius={"20px"}>
                    <CardHeader>
                    <Heading fontSize={{base:"2em", lg:"1.8em"}} mb="2px" p="0px" color={"#29B3FE"}>{plan.title}</Heading>
                    </CardHeader>
                    <CardBody>
                    ...
                    <CardFooter display={"flex"} flexDirection="column" gap="20px">
                        ...
                        <Button color="white" bg={"#29B3FE"} borderRadius={"50px"} _hover={{outline:"1px solid #359EFA", bg:"white", color:"#359EFA"}} fontSize="1em" p="10px 10px">{plan.cta}</Button>
                    </CardFooter>
                </Card>
                )}
            </SimpleGrid>
