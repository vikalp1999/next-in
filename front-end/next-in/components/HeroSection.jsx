            ...
            <Flex w={{base:"95%", md:"80%", lg:"60%" }} m="auto" p={"20px"} flexDirection={{base:"column-reverse", lg:"row"}} alignItems="center">
                <Flex  alignItems="center" w={{base:"95%", lg:"120%"}}>
                    <VStack display={"flex"} alignItems="flex-start" gap={"10px"} w="100%">
                        ...
                        <SignupLink href={"/signup"} fontSize={{base:"18px",lg:"22px"}} fontWeight={"500"} bg={"#F5B544"} p={{base:"5px 20px",lg:"12px 20px"}} borderRadius={"50px"} textAlign="center" _hover={{outline:"3px solid #F5B544", bg:"white"}} sx={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>Sign up for free ⇥</SignupLink>
                    </VStack>
                </Flex>
